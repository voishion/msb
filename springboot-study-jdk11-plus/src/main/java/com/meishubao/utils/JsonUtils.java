...
import com.meishubao.jackson.LocalDateTimeDeserializer;
import com.meishubao.jackson.LocalDateTimeSerializer;
import com.meishubao.exception.JsonHandleException;
...
public class JsonUtils {
     ...
     * <pre>使用方法:<code>String json = JsonUtils.toJson(person);<code/></pre>
     *
     * @param object
     * @return
     */
    ...
    /**
     * Object转换成json字符串，宽松的，建议在日志打印中使用
     * <pre>使用方法:<code>String json = JsonUtils.toJson(person, objectMapper);<code/></pre>
     *
     * @param object
     * @param objectMapper
     * @return
     ...
     * <pre>使用方法:<code>String json = JsonUtils.safeToJson(person);<code/></pre>
     *
     * @param object
     * @return
    ...
    /**
     * Object转换成json字符串，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>String json = JsonUtils.safeToJson(person, objectMapper);<code/></pre>
     *
     * @param object
     * @param objectMapper
     * @return
     ...
     * <pre>使用方法:<code>byte[] bytes = JsonUtils.safeToBytes(person);<code/></pre>
     *
     * @param object
     * @return
     * @throws JsonProcessingException
    ...
    /**
     * Object转换成字节数组，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>byte[] bytes = JsonUtils.safeToBytes(person, objectMapper);<code/></pre>
     *
     * @param object
     * @param objectMapper
     * @return
    ...
    /**
     * 类型转换，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Person person = JsonUtils.safeToObject(map, Person.class);<code/></pre>
     *
     * @param object
     * @return
     * @throws JsonProcessingException
    ...
    /**
     * 类型转换，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Person person = JsonUtils.safeToObject(map, Person.class, objectMapper);<code/></pre>
     *
     * @param object
     * @param objectMapper
     * @return
     ...
     * <pre>使用方法:<code>Animal&lt;Monkey&gt; animal = JsonUtils.safeToObject(map, new TypeReference&lt;&gt;(){});<code/></pre>
     *
     * @param object
     * @return
     * @throws JsonProcessingException
    ...
    /**
     * 类型转换，支持自定义泛型，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Animal&lt;Monkey&gt; animal = JsonUtils.safeToObject(map, new TypeReference&lt;&gt;(){}, objectMapper);<code/></pre>
     *
     * @param object
     * @param objectMapper
     * @return
     ...
     * <pre>使用方法:<code>String json = JsonUtils.toJsonIgnoreNull(person);<code/></pre>
     *
     * @param object
     * @return
     */
    ...
    /**
     * Object转换成json字符串，忽略空值，宽松的，建议在日志打印中使用
     * <pre>使用方法:<code>String json = JsonUtils.toJsonIgnoreNull(person, objectMapper);<code/></pre>
     *
     * @param object
     * @param objectMapper
     * @return
     ...
     * <pre>使用方法:<code>String json = JsonUtils.safeToJsonIgnoreNull(person);<code/></pre>
     *
     * @param object
     * @return
     * @throws JsonProcessingException
    ...
    /**
     * Object转换成json字符串，忽略空值，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>String json = JsonUtils.safeToJsonIgnoreNull(person, objectMapper);<code/></pre>
     *
     * @param object
     * @param objectMapper
     * @return
     ...
     * <pre>使用方法:<code>Person person = JsonUtils.safeRead(json, Person.class);<code/></pre>
     *
     * @param json
     * @param clazz
     * @return
    ...
    /**
     * json字符串转换成Object，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Person person = JsonUtils.safeRead(json, Person.class, objectMapper);<code/></pre>
     *
     * @param json
     * @param clazz
     * @param objectMapper
     ...
     * <pre>使用方法:<code>Animal&lt;Monkey&gt; animal = JsonUtils.safeRead(json, new TypeReference&lt;&gt;(){});<code/></pre>
     *
     * @param json
     * @param typeReference
     * @return
    ...
    /**
     * json字符串转换成Object，支持自定义泛型，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Animal&lt;Monkey&gt; animal = JsonUtils.safeRead(json, new TypeReference&lt;&gt;(){}, objectMapper);<code/></pre>
     *
     * @param json
     * @param typeReference
     * @param objectMapper
     ...
     * <pre>使用方法:<code>Person person = JsonUtils.safeRead(bytes, Person.class);<code/></pre>
     *
     * @param bytes
     * @param clazz
     * @return
    ...
    /**
     * 字节数组转换成Object，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Person person = JsonUtils.safeRead(bytes, Person.class, objectMapper);<code/></pre>
     *
     * @param bytes
     * @param clazz
     * @param objectMapper
     ...
     * <pre>使用方法:<code>Animal&lt;Monkey&gt; animal = JsonUtils.safeRead(bytes, new TypeReference&lt;&gt;(){});<code/></pre>
     *
     * @param bytes
     * @param typeReference
     * @return
    ...
    /**
     * 字节数组转换成Object，支持自定义泛型，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Animal&lt;Monkey&gt; animal = JsonUtils.safeRead(bytes, new TypeReference&lt;&gt;(){}, objectMapper);<code/></pre>
     *
     * @param bytes
     * @param typeReference
     * @param objectMapper
     ...
     * <pre>使用方法:<code>Person person = JsonUtils.safeRead(inputStream, Person.class);<code/></pre>
     *
     * @param inputStream
     * @param clazz
     * @return
    ...
    /**
     * 输入流转换成Object，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Person person = JsonUtils.safeRead(inputStream, Person.class, objectMapper);<code/></pre>
     *
     * @param inputStream
     * @param clazz
     * @param objectMapper
     ...
     * <pre>使用方法:<code>Animal&lt;Monkey&gt; animal = JsonUtils.safeRead(inputStream, new TypeReference&lt;&gt;(){});<code/></pre>
     *
     * @param inputStream
     * @param typeReference
     * @return
    ...
    /**
     * 输入流转换成Object，支持自定义泛型，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Animal&lt;Monkey&gt; animal = JsonUtils.safeRead(inputStream, new TypeReference&lt;&gt;(){}, objectMapper);<code/></pre>
     *
     * @param inputStream
     * @param typeReference
     * @param objectMapper
     ...
     * <pre>使用方法:<code>Map&lt;String, Object&gt; map = JsonUtils.safeToMap(json, String.class, Object.class);<code/></pre>
     *
     * @param json
     * @param keyType
     * @param valueType
    ...
    /**
     * json转换成Map，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Map&lt;String, Object&gt; map = JsonUtils.safeToMap(json, String.class, Object.class, objectMapper);<code/></pre>
     *
     * @param json
     * @param keyType
     * @param valueType
     ...
     * <pre>使用方法:<code>List&lt;String&gt; list = JsonUtils.safeToList(json, String.class);<code/></pre>
     *
     * @param json
     * @param valueType
     * @return
    ...
    /**
     * json转换成List，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>List&lt;String&gt; list = JsonUtils.safeToList(json, String.class, objectMapper);<code/></pre>
     *
     * @param json
     * @param valueType
     * @param objectMapper
     ...
     * <pre>使用方法:<code>Set&lt;String&gt; set = JsonUtils.safeReadSet(json, String.class);<code/></pre>
     *
     * @param json
     * @param valueType
     * @return
    ...
    /**
     * json转换成Set，自动去重，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Set&lt;String&gt; set = JsonUtils.safeReadSet(json, String.class, objectMapper);<code/></pre>
     *
     * @param json
     * @param valueType
     * @param objectMapper
     ...
     * <pre>使用方法:<code>Set&lt;String&gt; set = JsonUtils.safeToCollection(json, String.class);<code/></pre>
     *
     * @param json
    ...
    /**
     * json转换成Collection，严谨的，建议在业务逻辑中使用
     * <pre>使用方法:<code>Set&lt;String&gt; set = JsonUtils.safeToCollection(json, String.class, objectMapper);<code/></pre>
     *
     * @param json
     * @param collectionType
     * @param valueType
