package com.meishubao.sample.config.wrapper;
...
/**
 * 防止XSS（跨站脚本攻击）以及SQL注入攻击RequestWrapper
 */
@Slf4j
public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
     ...
     * SQL注入正则
     */
    private final static String badStrReg =
    ...
    private String getBodyString(HttpServletRequest httpServletRequest) throws IOException {
        ...
        try (BufferedReader isr = new BufferedReader(new InputStreamReader(inputStream, StandardCharsets.UTF_8))) {
            String line = "";
