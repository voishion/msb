...
//        extractCombination();
    ...
    public static void collectHandle() {
        List<String> listA = Arrays.asList(new String[]{"1", "2", "3", "4", "6"});
        List<String> listB = Arrays.asList(new String[]{"3", "4", "5"});
        //1、并集 union //输出: [1, 2, 3, 4, 5, 6]
        System.out.println(org.apache.commons.collections4.CollectionUtils.union(listA, listB));
        //2、交集 intersection //输出:[3, 4]
        System.out.println(org.apache.commons.collections4.CollectionUtils.intersection(listA, listB));
        //3、交集的补集（析取）disjunction //输出:[1, 2, 5, 6]
        System.out.println(org.apache.commons.collections4.CollectionUtils.disjunction(listA, listB));
        //4、差集（扣除）//输出:[1, 2]
        System.out.println(org.apache.commons.collections4.CollectionUtils.subtract(listA, listB));
    }
    ...
    public static void createStream() {
        ...
        List<String> collect1 = IntStream.range(1, 11).mapToObj(f -> f).map(n -> StrUtil.fillBefore(Convert.toStr(n), '0', 2)).collect(Collectors.toList());
